...
def weather_finder():
    print("""
  ____ __ __   ___ ____   ____  ____   ___       ____ ____  ____  __ __  ____ _          ______   ___ ___ ___ ____  ____    ___ ______ __ __ ____    ___ 
 /    |  |  | /  _|    \ /    |/    | /  _]     /    |    \|    \|  |  |/    | |        |      | /  _|   |   |    \|    \  /  _|      |  |  |    \  /  _]
|  o  |  |  |/  [_|  D  |  o  |   __|/  [_     |  o  |  _  |  _  |  |  |  o  | |        |      |/  [_| _   _ |  o  |  D  )/  [_|      |  |  |  D  )/  [_ 
|     |  |  |    _|    /|     |  |  |    _]    |     |  |  |  |  |  |  |     | |___     |_|  |_|    _|  \_/  |   _/|    /|    _|_|  |_|  |  |    /|    _]
|  _  |  :  |   [_|    \|  _  |  |_ |   [_     |  _  |  |  |  |  |  :  |  _  |     |      |  | |   [_|   |   |  |  |    \|   [_  |  | |  :  |    \|   [_ 
|  |  |\   /|     |  .  |  |  |     |     |    |  |  |  |  |  |  |     |  |  |     |      |  | |     |   |   |  |  |  .  |     | |  | |     |  .  |     |
|__|__| \_/ |_____|__|\_|__|__|___,_|_____|    |__|__|__|__|__|__|\__,_|__|__|_____|      |__| |_____|___|___|__|  |__|\_|_____| |__|  \__,_|__|\_|_____|""")
    print("\n                                                                 W  e  l  c  o  m  e ")
    print("                                           to The Average Annual Temperature for Each US State Finder!")
    print("")
    print("""--..,___.--,--'`,--..-.--+--.,,-,,..---..-.-+--.,,-,,..._.-..-._.-:-.""")
    ...
    if user in weather:
        print("")
        print("The Average Annual Temperature of " + user + " " + weather[user])
    else:
        print("")
